                        ...
                        <div>
                            <div className="homePageSection1">
                                ...
                                <div className="container">
                                    ...
                                    <form className="topSearch" onSubmit={(event) => {
                                        ...
                                        <input type="text" style={{ padding: "0px 3px", border: "none", margin: "0px" }} onChange={this.handleChage} placeholder="Search Images" name="search" id="search" />
                                    </form>

                                </div>
                            </div>
                            <div className="container-fluid black">
                                <div className="container homePageSection2">
                                    <div className="row" style={{ padding: "13px" }} >
                                        ...
                                        <div className="col-sm-6 exploreButton">
                                            <Link to="/explore" className="waves-effect btn transparent" style={{ border: '1px solid white' }}>
                                ...
                                <div className="container">
                                    ...
                                    <div className="row">
                                        ...
                                        {categoryArray.map((item, index) => {
                                            return (
                                                <div key={index} className="col-sm-4 col-xs-6 col-md-3 p-2" >
                                                    <div className="card">
                                                        <div className="card-image">
                                                            <figure className="snip1321" >
                                                                <img className="responsive-img categoryImages " src={item.src} alt="sq-sample26" />
                            ...
                            <div className="container">
                                ...
                                <div className="row popularSearch">
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Birthday</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Facebook Logo</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Unicorn</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Shamrock</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Solar System</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Rainbow</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Congratulations</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Thank You</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Smiley Face</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Leprechaun</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Spring</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Flower Drawing</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Food Chain</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Butterfly</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Bird Drawing</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Great Job</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">White Background</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Skull and Crossbones</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Purple Background</Link> </li>
                                    <li className="col-sm-3 col-xs-6 "> <Link to="">Beach</Link> </li>
                                </div>
                            </div>
                            ...
                            {/* section4 */}
                            <div className="parallax-container" style={{ height: "fit-content" }}>
